...
window.addEventListener('load',()=>{
  ...
  const loadLearningExtensions=()=>{if(document.querySelector('script[data-lab-book-bootstrap]'))return;const x=document.createElement('script');x.src='lab-book-bootstrap.js?v=lab-detail-20260915c';x.async=false;x.dataset.labBookBootstrap='1';document.body.appendChild(x);};

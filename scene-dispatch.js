...
window.addEventListener('load',()=>{
  ...
  const loadLearningExtensions=()=>{if(document.querySelector('script[data-lab-book-bootstrap]'))return;const x=document.createElement('script');x.src='lab-book-bootstrap.js?v=20260917-practicals-456-run1';x.async=false;x.dataset.labBookBootstrap='1';document.body.appendChild(x);};

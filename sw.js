const CACHE='practical-lab-v20260916-5';
const ASSETS=[
'./','./index.html','./styles.css','./visual-upgrades.css','./learning-tools.css','./ui-polish-v3.css','./app-icon.svg','./manifest.webmanifest','./assets/rp04-young-modulus.png','./assets/rp04-young-modulus.glb','./assets/rp05-resistivity-wire.png','./assets/rp08-boyle-syringe.png','./assets/rp10-wire-balance.png','./assets/rp11-search-coil.png',
